	...
	<CENTER>
		...
		<form method="POST"
			...
			<input type="text"
				name="mod_title"
				size="30"
				value="<?php echo $edit_r->title; ?>" /><br />
			<textarea name="mod_content"
				cols="30"
				rows="10"><?php echo $edit_r->content ?></textarea><br />
			<input type="text"
				name="mod_lat" size="30"
				value="<?php echo $edit_r->lat; ?>" /><br />
			<input type="text"
				name="mod_lng" size="30"
				value="<?php echo $edit_r->lng; ?>" /><br />
