...
class Q2 {
	public static void main(String[] args) {
		...
		Q2Parser parser = new Q2Parser(tm);
...
interface DataPart {
	...
	String tokens = "bcdfe#"; // list of tokens
	String nonTerms = "SABCD"; // list of non-terminals

	// right-hand sides of productions in reverse order
	String[] pTab = { "dA", "fB", "bC", "cD", "e" };

	int[][] parseTable = {
			{ -1, -1, -1, -1, 0, -1 }, // -1 means reject
			{ -1, -1, -1, -1, 1, -1 }, // Non-neg numbers are
			{ -1, -1, -1, -1, 2, -1 }, // production numbers
			{ -1, -1, -1, -1, 3, -1 },
			{ -1, -1, -1, -1, 4, -1 }
	};
} // end of DataPart
...
class Q2Parser implements DataPart {
	private ArgsTokenMgr tm;
	private Stack<Character> stk;
	private char currentToken;

	// -----------------------------------------
	public Q2Parser(ArgsTokenMgr tm) {
		this.tm = tm; // save tm
