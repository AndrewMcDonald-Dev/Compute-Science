...
class Q3 {
	public static void main(String[] args) {
		...
		Q3Parser parser = new Q3Parser(tm);
...
interface DataPart {
	...
	String tokens = "d#"; // list of tokens
	String nonTerms = "SABC"; // list of non-terminals
...
class Q3Parser implements DataPart {
	private ArgsTokenMgr tm;
	private Stack<Character> stk;
	private char currentToken;

	// -----------------------------------------
	public Q3Parser(ArgsTokenMgr tm) {
		this.tm = tm; // save tm
