...
catnames = ['EOF', 'print', 'UNSIGNEDINT', 'NAME', 'ASSIGNOP',
            ...
            'TIMES', 'NEWLINE', 'ERROR', 'PROGRAM', 'INTEGER', 'NEGATE']
...
def main():
    ...
    interpreter(ast)  # interpret bytecode in co_code
...
def parser():
    ...
    return program()     # call start symbol function
